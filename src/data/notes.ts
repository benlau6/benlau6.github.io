...
export function getPostSortDate(post: CollectionEntry<"notes">) {
...
export function sortMDByDate(posts: CollectionEntry<"notes">[]) {
 ...
 */
export function groupPostsByYear(posts: CollectionEntry<"notes">[]) {
 ...
 *  Note: This function doesn't filter draft posts, pass it the result of getAllPosts above to do so.
 *  */
export function getAllTags(posts: CollectionEntry<"notes">[]) {
 ...
 *  Note: This function doesn't filter draft posts, pass it the result of getAllPosts above to do so.
 *  */
export function getUniqueTags(posts: CollectionEntry<"notes">[]) {
 ...
 *  Note: This function doesn't filter draft posts, pass it the result of getAllPosts above to do so.
 *  */
export function getUniqueTagsWithCount(posts: CollectionEntry<"notes">[]): [string, number][] {
	return [
